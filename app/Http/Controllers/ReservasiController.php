...
class ReservasiController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        $reservasi = Reservasi::find($id);
        if($reservasi){
            $reservasi->nomor_pesan = $request->nomor_pesan ? $request->nomor_pesan : $reservasi->nomor_pesan;
            ...
            $reservasi->harga_dp = $request->harga_dp ? $request->harga_dp : $reservasi->harga_dp;
            $reservasi->save();
            return response()->json([
                'status' => 200,
                'data' => $reservasi
